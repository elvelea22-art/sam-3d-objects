...
import sam3d_objects.mixhavior as mixhavior
from sam3d_objects.utils.model.hash import hash_module, diff_hashed_model
...
class EMA(Callback):
    ...
    def __init__(
        ...
        assert not (self.start_step is not None and self.start_epoch is not None), "start_step and start_epoch cannot be set at the same time"
