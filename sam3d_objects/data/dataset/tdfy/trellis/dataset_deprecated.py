...
from sam3d_objects.data.dataset.tdfy.transforms_3d import get_rotation_about_x_axis
...
class PerSubsetDataset(torch.utils.data.Dataset):
    ...
    def _set_transforms(self):
        # # TODO: refactor this to use sam3d_objects.data.dataset.tdfy.img_and_mask_transforms.RGBAImageProcessor
